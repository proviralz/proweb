...
const AdminJobDetails = () => {
    ...
    useEffect(()=> {
        const getJobs = async ()=> {
            try {
                const res = await publicRequest.get(`jobs/6630f5fbc2369eb3310a608f`)
    ...
    //             const proposalRes = await publicRequest.get(`proposal/find/6630f5fbc2369eb3310a608f?providerId=${user?._id}`)
