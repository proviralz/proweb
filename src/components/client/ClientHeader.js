            ...
            <div className=' flex justify-between md:justify-start gap-3 md:gap-10 w-full items-center'>
                ...
                <div className=' hidden md:flex'>
                    <nav className=' flex gap-4 text-neutral-500 text-sm font-light'>
                        <Link href={'/projects'} className={pathname.startsWith('/projects')? 'text-[#31013f]': ''}>
                            My Projects
                        </Link>
                        <Link href={'/top-providers'} className={pathname.startsWith('/top-providers')? 'text-[#31013f]': ''}>
      ...
      {isMobileMenuOpen && (
        <div className='md:hidden shadow-md fixed top-0 left-0 h-screen z-50 bg-white w-4/5 p-5'>
          ...
          <nav className='flex mt-8 flex-col gap-4 text-neutral-500 text-sm font-light'>
            <Link href={'/projects'} className={pathname.startsWith('/projects') ? 'text-[#31013f]' : ''} onClick={toggleMobileMenu}>
              My projects
            </Link>
            <Link href={'/top-providers'} className={pathname.startsWith('/top-providers') ? 'text-[#31013f]' : ''} onClick={toggleMobileMenu}>
              Top service providers
            </Link>
