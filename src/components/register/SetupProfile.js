...
import SelectSkilled from './SelectSkilled';

const SetupProfile = ({showSetup, setShowSetup}) => {
  ...
  return (
    <div className={`${showSetup? 'flex': 'hidden'} h-screen overflow-y-scroll bg-white w-full flex justify-center`}>
        <div className=' fixed top-0  w-full left-0'>
            <SelectSkilled showSelectSkilled={showSelectSkilled} setShowSelectSkilled={setShowSelectSkilled} />
        </div>
        <div className=' p-5'>
            <Header />
            ...
            <div className=' flex justify-end mt-5'>
                <p onClick={()=> setShowSelectSkilled(true)} className=' bg-[#31013f] p-4 text-white inline-block rounded-md w-48 text-center'>
                    Continue
                </p>
            </div>
            <div className=' h-10'>
